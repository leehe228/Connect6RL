...
if __name__ == '__main__':
    ...
    for episode in range(run_episode + test_episode):
        ...
        state1 = env_info[brain_name].vector_observations[0]
        episode_rewards1 = 0
        done1 = False

        # 두번째 에이전트의 상태, episode_rewards, done 초기화
        state2 = env_info[brain_name].vector_observations[1]
        episode_rewards2 = 0
        done2 = False
        ...
        while not done:
            ...
            next_state1 = env_info[brain_name].vector_observations[0]
            ...
            next_state2 = env_info[brain_name].vector_observations[1]
